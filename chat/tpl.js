...
const compiled = function(message) {
  switch (message.msgType) {
    ...
    case 'voice':
      ...
      break
    case 'video':
      return `<xml><ToUserName><![CDATA[${message.FromUserName}]]></ToUserName><FromUserName><![CDATA[${message.ToUserName}]]></FromUserName><CreateTime>${message.createTime}</CreateTime><MsgType><![CDATA[video]]></MsgType><Video><MediaId><![CDATA[${message.media_id}]]></MediaId><Title><![CDATA[${message.title}]]></Title><Description><![CDATA[description]]></Description></Video></xml>`
      break
    case 'music':
